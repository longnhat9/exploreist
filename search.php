                        ...
                        <div class="row custom-row-gap">
                            ...
                            <div class="col-xl-8 order-xl-0">
                                ...
                                if (!(isset($_GET['search']) && $_GET['search'])) {
                                    die("Do not param in search");
                                }
                                $data = $_GET['search'];
                                $ListPosts = SearchPostsByParam($data);
                                if (!$ListPosts) {
                                    die("Not found the posts");
                                }
                                foreach($ListPosts as $Post) {
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="card card-style-1 mb-lg-30 md-mb-20 mb-10  wow fadeInUp" data-wow-delay="0.3s">
                                            ...
                                            <a href="./post-detail.php?id=<?php echo $Post['PostID']; ?>"> <img src="./public/images/<?php echo $Post['Image']; ?>" data-src="./public/images/<?php echo $Post['Image']; ?>" class="card-img-top" alt="beach"> </a>                              
                                            </div>
                                            
                                            <div class="card-body">
                                                <div class="card-header text-uppercase">
                                                    <a href="./category.php?id=<?php echo $Post['CategoriesID']; ?>" class="fs-6 card-header-title">
                                                    <?php
                                                    $Category = GetNameCategoryByID($Post['CategoriesID']);
                                                    echo $Category;
                                                    ?>
                                                    </a>
                                                </div>
                                                <h5 class="fs-1 card-title "><a href="./post-detail.php?id=<?php echo $Post['PostID']; ?>" class="blog-title"><?php echo $Post['Title']; ?></a></h5>
                
                                                <ul class="list-unstyled card-meta lead ">
                                                    <li>By <a href="author-1.html" class="blog-author fw-bold"><?php GetFullNameByUserID($Post['UserID']); ?></a></li>
